            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <button 
                  ...
                  className="bg-[#145587] text-white px-8 py-4 rounded-lg hover:bg-[#145587]/90 transition-colors font-semibold"
                >
                  Découvrir nos services
                </button>
                <button 
                  onClick={scrollToContact}
                  className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg hover:border-[#145587] hover:text-[#145587] transition-colors font-semibold"
                >
                  Demander un devis
                </button>
              </div>
