  ...
  const services = [
    {
      ...
      available: true,
      detailedDescription: "Notre service de location de linge de lit comprend une gamme complète de produits en coton de qualité supérieure. Nous proposons des draps plats, housses de couette et taies d'oreiller dans toutes les tailles standards.",
      additionalFeatures: [
        "Draps 100% Coton pour un confort optimal",
    ...
    },
    {
      ...
      description: "Serviettes, Draps de Bain, tapis de bain. Textiles absorbants et moelleux pour votre bien-être.",
      ...
      additionalFeatures: [
        "Serviettes de bain en coton éponge ultra-doux",
        "Draps de bain de 140cm en coton éponge ultra-doux",
